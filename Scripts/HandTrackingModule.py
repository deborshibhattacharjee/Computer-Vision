...
class handDetector():
    ...
    def fingersUp(self, ):
        ...
        if abs(self.lmList[self.tipIds[0]][1] - self.lmList[self.tipIds[0] - 1][1]) > 14:
            fingers.append(1)
        ...
        for ID in range(1, 5):
            if abs(self.lmList[self.tipIds[ID]][2] < self.lmList[self.tipIds[ID] - 2][2]):
                fingers.append(1)
            else:
                fingers.append(0)
